...
public class CommonFlag {
	...
	public static String getF_Port() {
		return f_Port;
	}
	...
	public static String getF_MMSVerifyUAGetUAInfo() {
	...
	public static String getF_MCSVerifyUAMSG() {
		return f_MCSVerifyUAMSG;
	}

	public static String getF_MCSVerifyUAGetMSG() {
		return f_MCSVerifyUAGetMSG;
	}

	public static String getF_MCSReciveUAMSGFB() {
