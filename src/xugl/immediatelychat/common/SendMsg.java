...
//			public void run() {
				...
				CommonVariables.getMsgRecordOperate().SaveMsgRecord(msgRecord, packageContext);
				CommonVariables.getChatOperate().UpdateLatestMsg(msgRecord, packageContext);
//			}
//		}).start();
	}
...
//		try {
//			msgObject.put(CommonFlag.getF_MsgSenderObjectID(), msgRecord.getMsgSenderObjectID());
//			msgObject.put(CommonFlag.getF_MsgSenderName(), msgRecord.getMsgSenderName());
//			msgObject.put(CommonFlag.getF_MsgContent(), msgRecord.getMsgContent());
//			msgObject.put(CommonFlag.getF_MsgRecipientObjectID(), msgRecord.getMsgRecipientObjectID());
//			msgObject.put(CommonFlag.getF_MsgRecipientGroupID(), msgRecord.getMsgRecipientGroupID());
...
//			e.printStackTrace();
//		}
//		return msgObject;//CommonFlag.getF_MCSVerifyUAMSG() + msgObject.toString();
//	}
			...
			public void run() {
				...
				try {
					...
					if(charcount>0)
					{
						...
						CommonVariables.getChatOperate().SetChat(objectID,jsonObject.getString("ContactPersonName"),1, packageContext);
